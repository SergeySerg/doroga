    ...
    <div class="row-fluid">
        <div class="span12">
                    ...
                    <div class="row-fluid">
                        <div class="span3">
                            <label>
                                ...
                                <input name='active' class="ace-switch ace-switch-6" type="checkbox" value=1 @if(isset($admin_comment) AND $admin_article->comment) checked="checked" @endif />
                                <span class="lbl"></span>
                            </label>
                        </div>
                    </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select id="form-field-select-1">
                        <option  @if(isset($admin_comment)) value='{{$admin_comment->rate}}' @endif />
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="user_name"  @if(isset($admin_comment)) value='{{$admin_comment->rate}}' @endif id="form-field-3" placeholder="Имя користувача" />
                </div>
            </div>
